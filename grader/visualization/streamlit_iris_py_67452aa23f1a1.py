...
fig_matrix.update_layout(title=f"Feature Relationships by Species")
...
df_line = pd.DataFrame(
    {"Number of Clusters": list(range(1, len(inertias) + 1)), "Inertia": inertias}
)
